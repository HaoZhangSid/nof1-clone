        ...
        <div className="grid grid-cols-2 gap-3 text-sm">
          ...
          <div className="rounded-xl border border-zinc-800 p-3">
            ...
            <div className="text-xl font-semibold" suppressHydrationWarning>
              {mounted && nextUpdateSec != null ? `00:00:${String(nextUpdateSec).padStart(2, "0")}` : "—"}
            </div>
          </div>
          ...
          <div className="rounded-xl border border-zinc-800 p-3">
            ...
            <div className="font-mono" suppressHydrationWarning>
              {mounted && serverTime ? new Date(serverTime).toLocaleTimeString([], { hour12:false }) : "—"}
            </div>
          </div>
          ...
          <div className="rounded-xl border border-zinc-800 p-3">
            ...
            <div className="font-mono" suppressHydrationWarning>
              {mounted && lastUpdated ? new Date(lastUpdated).toLocaleTimeString([], { hour12:false }) : "—"}
            </div>
          </div>
        </div>
      </CardContent>
